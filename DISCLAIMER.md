...
- **Professional Rules**: Law Society of Singapore members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Singapore Statutes Online (sso.agc.gov.sg))
...
This Tool aggregates data from official Singapore legal databases. However:
...
- LawNet, Westlaw SG, LexisNexis SG
...
- Singapore law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (Singapore Statutes Online (sso.agc.gov.sg))
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Singapore-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Singapore-law-mcp/issues
